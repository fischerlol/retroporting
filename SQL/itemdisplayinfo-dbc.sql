...
BEGIN
    INSERT INTO itemdisplayinfo(id, leftmodel, leftmodeltexture, inventoryicon1, groupsoundindex, helmetgeosetvisual1, helmetgeosetvisual2) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, leftmodel, rightmodel, leftmodeltexture, rightmodeltexture, inventoryicon1, groupsoundindex) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, upperarmtexture, lowerarmtexture, uppertorsotexture, lowertorsotexture, inventoryicon1, groupsoundindex) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, upperarmtexture, lowerarmtexture, uppertorsotexture, lowertorsotexture, inventoryicon1, groupsoundindex, geosetgroup1) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, upperarmtexture, lowerarmtexture, uppertorsotexture, lowertorsotexture, upperlegtexture, lowerlegtexture, inventoryicon1, groupsoundindex, geosetgroup1, geosetgroup3) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, lowerarmtexture, inventoryicon1, groupsoundindex) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, lowerarmtexture, handstexture, inventoryicon1, groupsoundindex, geosetgroup1) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, upperlegtexture, inventoryicon1, groupsoundindex) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, upperlegtexture, lowerlegtexture, inventoryicon1, groupsoundindex) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, upperlegtexture, lowerlegtexture, inventoryicon1, groupsoundindex, geosetgroup3) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, leftmodel, rightmodel, leftmodeltexture, rightmodeltexture, lowerlegtexture, foottexture, inventoryicon1, groupsoundindex, geosetgroup1) VALUES
...
BEGIN
    INSERT INTO itemdisplayinfo(id, leftmodel, leftmodeltexture, inventoryicon1, groupsoundindex) VALUES
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70000;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70001;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70002;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70003;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70004;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70005;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70006;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70007;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70008;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70009;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70010;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70011;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70012;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70013;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70014;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70015;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 70016;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80000;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80001;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80002;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80003;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80004;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80005;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80006;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80007;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80008;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80009;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80010;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80011;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80012;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80013;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80014;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80015;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80016;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80017;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80018;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80019;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80020;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80021;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80022;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80023;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80024;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80025;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80026;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80027;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80028;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80029;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80030;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80031;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80032;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80033;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80034;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80035;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80036;
...
-- Bloodthirsty Gladiator's Cuffs
DELETE FROM `itemdisplayinfo` WHERE `id` = 80037;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80038;
...
-- Bloodthirsty Gladiator's Cord
DELETE FROM `itemdisplayinfo` WHERE `id` = 80039;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80040;
...
-- Bloodthirsty Gladiator's Treads
DELETE FROM `itemdisplayinfo` WHERE `id` = 80041;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80042;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80043;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80044;
...
-- Bloodthirsty Gladiator's Armguards
DELETE FROM `itemdisplayinfo` WHERE `id` = 80045;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80046;
...
-- Bloodthirsty Gladiator's Girdle
DELETE FROM `itemdisplayinfo` WHERE `id` = 80047;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80048;
...
-- Bloodthirsty Gladiator's Warboots
DELETE FROM `itemdisplayinfo` WHERE `id` = 80049;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80050;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80051;
...
-- Bloodthirsty Gladiator's Satin Robe
DELETE FROM `itemdisplayinfo` WHERE `id` = 80052;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80053;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80054;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80055;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80056;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80057;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80058;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80059;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80060;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80061;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80062;
...
-- Bloodthirsty Gladiator's Cuffs
DELETE FROM `itemdisplayinfo` WHERE `id` = 80063;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80064;
...
-- Bloodthirsty Gladiator's Cord
DELETE FROM `itemdisplayinfo` WHERE `id` = 80065;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80066;
...
-- Bloodthirsty Gladiator's Treads
DELETE FROM `itemdisplayinfo` WHERE `id` = 80067;
...
-- Bloodthirsty Gladiator's Chain Helm
DELETE FROM `itemdisplayinfo` WHERE `id` = 80068;
...
-- Bloodthirsty Gladiator's Chain Spaulders
DELETE FROM `itemdisplayinfo` WHERE `id` = 80069;
...
-- Bloodthirsty Gladiator's Chain Armor
DELETE FROM `itemdisplayinfo` WHERE `id` = 80070;
...
-- Bloodthirsty Gladiator's Sabatons
DELETE FROM `itemdisplayinfo` WHERE `id` = 80075;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80076;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80077;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80078;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80079;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80080;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80081;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80082;
...
DELETE FROM `itemdisplayinfo` WHERE `id` = 80083;
